...
class JaegerBefore
{
    ...
    public function __construct()
    {
        ...
        JaegerBefore::$tracer = static::$jeagerConfig->initTrace(JaegerBefore::$config['service_name'], JaegerBefore::$config['collector']);
    ...
    public function handle($request, Closure $next)
    {
        ...
        JaegerBefore::$span->addBaggageItem('version', JaegerBefore::$config['service_version']);
