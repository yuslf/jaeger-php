...
class MY_Loader {
	...
	public function dbutil()
	{
        ...
        require_once(APPPATH.'database/drivers/'.$CI->db->dbdriver.'/'.$CI->db->dbdriver.'_utility.php');
	...
	public function dbforge()
	{
        ...
        require_once(APPPATH.'database/drivers/'.$CI->db->dbdriver.'/'.$CI->db->dbdriver.'_forge.php');
...
/* Location: ./system/core/MY_Loader.php */